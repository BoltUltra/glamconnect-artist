  ...
  >
    ...
    >
      <div class="md:px-[63px] px-5 md:pt-10 pt-8">
        ...
        >
          Sign up as Make up Artist
        </h2>
        <form @submit.prevent="handleSubmit" class="space-y-6 md:px-[63px]">
          <h4 class="text-center font-bold text-2xl">Personal Information</h4>
          <div class="mb-4">
          ...
          <div class="mb-4">
            ...
            <input
              ...
              class="form-input"
              :class="{
                'border-red-500': errors.experience,
                'border-gray-300': !errors.experience,
              }"
            />
          ...
          <div class="mb-4">
            ...
            <input
              ...
              :class="{
                ...
                'border-gray-300': !errors.location,
              }"
            />
          ...
          <div class="mb-4">
            ...
            <input
              ...
              class="form-input"
              :class="{
                'border-red-500': errors.specialization,
                'border-gray-300': !errors.specialization,
              }"
            />
      ...
      <div class="hidden md:block bg-orange-50">
        <img src="/images/artist-signup.webp" alt="" />
      </div>
    </div>
  </div>
</template>
