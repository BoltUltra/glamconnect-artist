    ...
    <div class="w-full max-w-[1440px] mx-auto px-5 py-8 md:py-10">
      ...
      <div class="flex items-center justify-between mb-10">
        ...
        <div class="flex items-center space-x-4 flex-grow max-w-2xl">
          ...
          <span
            class="text-sm md:text-base"
            :class="currentStep === 3 ? 'text-orange-600 font-medium' : ''"
          >
      ...
      <div class="max-w-2xl mx-auto">
        <transition name="fade" mode="out-in">
          ...
          >
            <h2 class="text-3xl font-bold mb-2">Business Information</h2>
            <p class="text-gray-600 dark:text-gray-300 mb-8">
              Please Provide the necessary information about your Business
            </p>
            ...
            <div class="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  type="text"
                  placeholder="Current Location of Your Business"
                  class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-500 dark:bg-transparent dark:text-gray-100"
              ...
              <div>
                <label for="businessEmail" class="block mb-2 font-medium"
                  >Email Address</label
                >
                <input
                  id="businessEmail"
                  ...
                  placeholder="example@mail"
                  class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-500 dark:bg-transparent dark:text-gray-100"
                  :class="{ 'border-red-500': errors.businessEmail }"
                />
                <p
                  v-if="errors.businessEmail"
              ...
              <div>
                <label for="specialization" class="block mb-2 font-medium"
                ...
                <input
                  ...
                  type="text"
                  placeholder="e.g Bridal Makeup etc"
                  class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-500 dark:bg-transparent dark:text-gray-100"
