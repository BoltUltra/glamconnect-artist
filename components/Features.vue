...
<template>
  <section class="md:px-20 px-5 py-10">
    ...
    <div class="mt-6 flex flex-col justify-center gap-8">
      <div class="grid md:grid-cols-5 items-center md:gap-0 gap-8">
        <div class="md:col-span-3 space-y-4 max-w-3xl">
          ...
          <p class="text-gray-600 dark:text-gray-100 text-lg">
            ...
            Streamline your business with easy-to-manage appointment scheduling.
            Stay organized, reduce cancellations, and fill your calendar faster
      ...
      <div class="grid md:grid-cols-5 items-center md:gap-0 gap-8">
        <div class="md:col-span-2 md:order-first order-last">
        ...
        <div class="md:col-span-3 space-y-4 max-w-3xl">
          ...
          <p class="text-gray-600 dark:text-gray-100 text-lg">
            ...
            ratings, showcase your expertise and attract more clients with
            up-to-the-minute feedback from satisfied customers
          </p>
        </div>
      </div>
      <div class="grid md:grid-cols-5 items-center md:gap-0 gap-8">
        <div class="md:col-span-3 space-y-4 max-w-3xl">
          ...
          <p class="text-gray-600 dark:text-gray-100 text-lg">
            ...
            notifications for new bookings, client updates, and special requests
            to keep your salon running smoothly and efficiently.
          </p>
        </div>
        <div class="md:col-span-2">
